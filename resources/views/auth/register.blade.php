                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <div style="text-align: center;">
                                        ...
                                        <label style="font-size: 12px; font-weight: lighter" for="agreement"
                                               class="col-form-label text-md-end">
                                            {{ __('Я ознакомился и принимаю условия')  }}
                                            <a href="{{asset('storage/agreement.pdf')}}" download="agreement.pdf">
                                                Согласия на обработку персональных данных</a>
                                        </label>
                                    </div>
                                </div>
                            </div>
