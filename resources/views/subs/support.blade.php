...
@section('content')
    ...
    <!-- /.navbar -->
    <div class="mt-5 pt-5">
        <h1 class="mt-5 pt-5 text-center">Выберите проект который вы хотите поддержать</h1>
    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group">
                                                    <button href="{{ route('cardItem', ['id' => 1]) }}" type="button" class="btn btn-sm btn-secondary">Подробнее</button>
                                                </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">QR код для оплаты</h5>
